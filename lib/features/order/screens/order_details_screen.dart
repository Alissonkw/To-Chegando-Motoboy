...
import 'package:tochegando_delivery/features/notification/domain/models/notification_body_model.dart';
import 'package:tochegando_delivery/features/chat/domain/models/conversation_model.dart';
import 'package:tochegando_delivery/features/order/domain/models/order_details_model.dart';
import 'package:tochegando_delivery/features/order/domain/models/order_model.dart';
import 'package:tochegando_delivery/helper/price_converter_helper.dart';
import 'package:tochegando_delivery/helper/responsive_helper.dart';
import 'package:tochegando_delivery/helper/route_helper.dart';
import 'package:tochegando_delivery/util/app_constants.dart';
import 'package:tochegando_delivery/util/dimensions.dart';
import 'package:tochegando_delivery/util/images.dart';
import 'package:tochegando_delivery/util/styles.dart';
import 'package:tochegando_delivery/common/widgets/confirmation_dialog_widget.dart';
import 'package:tochegando_delivery/common/widgets/custom_app_bar_widget.dart';
import 'package:tochegando_delivery/common/widgets/custom_button_widget.dart';
import 'package:tochegando_delivery/common/widgets/custom_image_widget.dart';
import 'package:tochegando_delivery/common/widgets/custom_snackbar_widget.dart';
import 'package:tochegando_delivery/features/order/widgets/camera_button_sheet_widget.dart';
import 'package:tochegando_delivery/features/order/widgets/cancellation_dialogue_widget.dart';
import 'package:tochegando_delivery/features/order/widgets/collect_money_delivery_sheet_widget.dart';
import 'package:tochegando_delivery/features/order/widgets/order_item_widget.dart';
import 'package:tochegando_delivery/features/order/widgets/verify_delivery_sheet_widget.dart';
import 'package:tochegando_delivery/features/order/widgets/info_card_widget.dart';
import 'package:tochegando_delivery/features/order/widgets/slider_button_widget.dart';
                  ...
                  action: () {
                    ...
                    if((cod! && accepted! && !restConfModel && !selfDelivery) || (parcel! && accepted!)) {
                      ...
                      if(orderVerificationActive && controllerOrderModel.chargePayer != 'sender' && cod) {
                        Get.bottomSheet(VerifyDeliverySheetWidget(
                          currentOrderModel: controllerOrderModel, verify: orderVerificationActive,
                          orderAmount: controllerOrderModel.orderAmount, cod: cod, isParcel: parcel, isSenderPay: false,
                        ), isScrollControlled: true).then((value) {
                          if(value == 'show_price_view') {
                            Get.bottomSheet(VerifyDeliverySheetWidget(
                              currentOrderModel: controllerOrderModel, verify: false, isSetOtp: false,
                              orderAmount: controllerOrderModel.orderAmount, cod: cod, isSenderPay: false, isParcel: parcel,
                            ), isScrollControlled: true);
                          }
                        });
                      } else if(orderVerificationActive && controllerOrderModel.chargePayer == 'sender' && cod){
                        Get.bottomSheet(VerifyDeliverySheetWidget(
                          currentOrderModel: controllerOrderModel, verify: orderVerificationActive,
                          orderAmount: controllerOrderModel.orderAmount, cod: cod, isSenderPay: true, isParcel: parcel,
                        ), isScrollControlled: true).then((value) {
                    ...
                    /*else if(pickedUp!) {
                      ...
                      else if((orderVerificationActive || cod) && !parcel){
                        Get.bottomSheet(VerifyDeliverySheetWidget(
                          currentOrderModel: controllerOrderModel, verify: orderVerificationActive,
                          orderAmount: controllerOrderModel.orderAmount, cod: cod,
                        ), isScrollControlled: true);
