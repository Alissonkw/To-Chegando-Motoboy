...
import 'package:tochegando_delivery/features/language/widgets/language_bottom_sheet_widget.dart';
import 'package:tochegando_delivery/features/profile/controllers/profile_controller.dart';
import 'package:tochegando_delivery/features/profile/widgets/notification_status_change_bottom_sheet.dart';
...
import 'package:tochegando_delivery/features/profile/widgets/profile_bg_widget.dart';
import 'package:tochegando_delivery/features/profile/widgets/profile_button_widget.dart';
import 'package:tochegando_delivery/features/profile/widgets/profile_card_widget.dart';
        ...
        return profileController.profileModel == null ? const Center(child: CircularProgressIndicator()) : ProfileBgWidget(
          ...
          mainWidget: SingleChildScrollView(physics: const BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              (profileController.profileModel != null && profileController.profileModel!.earnings == 1) ? Padding(
                padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeSmall),
                child: ProfileButtonWidget(icon: Icons.monetization_on, title: 'my_earning'.tr, onTap: () {
